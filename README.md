![Jest](https://github.com/MyCryptoHQ/landing/workflows/Jest/badge.svg)
...
1.  **Create a Gatsby site.**
    ...
    gatsby new my-default-starter https://github.com/RobertoMSousa/gatsby-typescript-starter-default
    ```
